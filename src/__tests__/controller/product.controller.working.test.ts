...
// Mock the entire validation module
...
// Mock the DTOs to avoid decorator issues
jest.mock('../../dto/product.dto', () => ({
  CreateProductDto: class CreateProductDto {},
  UpdateProductDto: class UpdateProductDto {},
}));
...
describe('Product Controller - Working Tests', () => {
